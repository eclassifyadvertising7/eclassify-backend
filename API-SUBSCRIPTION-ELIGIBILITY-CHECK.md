...
### 6. Not Eligible - Pending Subscription Exists

```json
{
  "success": true,
  "message": "You already have a pending subscription for this category. Please wait for admin verification or cancel the pending subscription before creating a new one.",
  "data": {
    "eligible": false,
    ...
    "quotaInfo": null,
    "suggestions": [
      "Wait for admin to verify your pending subscription",
      "Contact support to check verification status",
      "Cancel pending subscription if you want to choose a different plan"
    ]
  }
}
```
...
### 7. Not Eligible - Already Has Free Plan
...
### 9. Not Eligible - Plan Not Available
...
| `PENDING_SUBSCRIPTION_EXISTS` | User has pending subscription awaiting verification | ❌ No |
